    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-3">
          <div className="w-16 h-16 rounded-full bg-[#6b7d47]/10 flex items-center justify-center">
          ...
          <div className="text-sm font-medium text-[#6b7d47]/50">No photos available</div>
        </div>
      </div>
    );
  }
          ...
          {Array.from({ length: 4 }).map((_, i) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center gap-1">
                <svg className="w-5 h-5 text-[#6b7d47]/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
            </div>
            ...
            {Array.from({ length: 4 - rightPhotos.length }).map((_, i) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-2 text-center px-4">
                  <div className="w-12 h-12 rounded-full bg-[#6b7d47]/10 flex items-center justify-center">
                    <svg className="w-6 h-6 text-[#6b7d47]/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div className="text-xs font-medium text-[#6b7d47]/50">
